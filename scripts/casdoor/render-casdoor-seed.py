...
This tool creates a minimal, idempotent baseline for the current project:
organization, OAuth application, Casbin model, common roles, common permissions
and optional role-user binding.

It does not import a full Casdoor dump and does not create/drop tables.
"""
...
def render(args: argparse.Namespace) -> str:
    ...
    lines.extend([
        ...
        "",
        "-- Generated values for aisphere-auth config:",
...
def main() -> int:
    ...
    if not args.client_secret.strip():
        print("[WARN] generated a random client_secret. Copy it from the SQL comments into aisphere-auth config.")
